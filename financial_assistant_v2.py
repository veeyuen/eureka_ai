# fix2b1_unified_engine_poc_v2.py
...
CODE_VERSION = "fix2b1_unified_engine_poc_v2"
...
# - fix2b1_unified_engine_poc_v2: Remove __future__ import to avoid placement SyntaxError when embedded; bump CODE_VERSION
