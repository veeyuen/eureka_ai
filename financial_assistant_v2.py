...
def classify_source_reliability(source: str) -> str:
    ...
    high = ["gov", "imf", "worldbank", "central bank", "fed", "ecb", "reuters", "spglobal", "economist", "mckinsey", "bcg",
...
def evidence_based_veracity(primary_data: dict, web_context: dict) -> dict:
   ...
   # citation_score = min(citation_density * 50, 25) # less forgiving citation score calc
    citations_score = min(100, (total_sources * 0.75 + high_quality_sources * 1.25) / max(1, num_findings) * 50)
