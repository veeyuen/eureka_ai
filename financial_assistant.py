...
SYSTEM_PROMPT = (
    "You are an analyst that only answers topics in business, finance, economics, or the markets.\n"
...
def main():
    ...
    st.title("Yureeka AI Analyst – Self‑Consistency + Cross‑Model Verification")
    ...
    if st.button("Analyze") and q:
        ...
        if not is_finance_query(q):
            st.error("❌ Query not recognized as relating to the business or financial domain. Please ask about markets, finance, or economics.")
            return
